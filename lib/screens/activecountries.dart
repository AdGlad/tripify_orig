...
class _CountryPageState extends State<CountryPage> {
  ...
  late Map<String, dynamic> _regionrecords;
  ...
  void initState() {
    StreamSubscription<QuerySnapshot> _userRegionListSubscription =
        FirebaseFirestore.instance
            ...
            .collection('country')
            .doc('AU')
            //.collection('/currentuser/*/country/*/region')
            .collection('region')
            .snapshots()
            .listen((snapshot) {
      _regionrecords = {};
      for (final document in snapshot.docs) {
        _regionrecords[document.id] = document.data()['countryName'];
//        keyValuesPaires.addAll({"AU-NSW": Colors.lightGreen});
    ...
    if (instruction != "NOT SUPPORTED") {
      ...
      //keyValuesPaires = {"AU-NT": Colors.amber};
